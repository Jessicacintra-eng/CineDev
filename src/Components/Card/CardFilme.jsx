  ...
  return (
    <div className={s.card} key={id}>
      ...
      <div className={s.info}>
        ...
        <span className={s.notes}> <img className='star' src="https://mcusercontent.com/8d01a411f692a38c571bf7140/images/170aa028-50c9-e00b-fab0-7fc833366372.png" /> {notas}</span>
        {/* <span>{descricaoDoFilme}</span> */}
        <div className={s.botaoDiv}>
